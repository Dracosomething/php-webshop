...
class PriceHelper
{
     ...
     */
    public function parseFloatToPrice(float $float): string
    {
        ...
        if (
            !str_ends_with($decimals, "0") && !str_ends_with($decimals, "-")
            && strlen($decimals) < 2
        ) { // checks if the decimals dont end in a 0, - and has a length bellow 2
